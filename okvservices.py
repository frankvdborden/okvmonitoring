                ...
                if key == 'value':
                    for vkey, vvalue in value.items():
                         if vkey == 'services':
                             ...
                             output=output + vvalue['RESTfulService'] + ","
                             output=output + vvalue['emailService'] + ","
                             output=output + vvalue['KMIPService'] + ","
                             output=output + vvalue['storageDB'] + ","
                             output=output + vvalue['auditVaultAgentMonitor'] + ","
                             output=output + vvalue['clusterService'] 
            print(output)
